 ...
 */
public class PostOffice implements  
	...
	private HashMultimap<int, Pair<MouseSubscriber,HShape>> _mouseSubs;
	 ...
	 */
	public void subscribe(MouseSubscriber sub, int button) {
	 ...
	 */
    public void subscribe(MouseSubscriber sub, int button, HShape region) {
        assert sub != null : "PostOffice.registerMouseSubscription: sub must be a valid MouseSubscriber";
	...
	public boolean removeMouseSubscriptions(MouseSubscriber sub) {
	  if(_mouseSubs.containsValue(sub)) {
	    ...
	    Set<Map.Entry<int, Pair<MouseSubscriber,HShape>>> all = _mouseSubs.entries();
	    Set<Map.Entry<int, Pair<MouseSubscriber,HShape>>> toRemove = new HashSet<Map.Entry<int, Pair<MouseSubscriber,HShape>>>();
	    for(Iterator<Map.Entry<int, Pair<MouseSubscriber,HShape>>> iter = all.iterator(); iter.hasNext(); ) {
	      Map.Entry<int, Pair<MouseSubscriber,HShape>> next = iter.next();
	    ...
	    // Remove references
	    for(Iterator<Map.Entry<int, Pair<MouseSubscriber,HShape>>> iter = toRemove.iterator(); iter.hasNext(); ) {
	      Map.Entry<int, Pair<MouseSubscriber,HShape>> next = iter.next();
	...
	public void keyPressed(KeyEvent e) {
		KeyMessage m = new KeyMessage(e.getKeyCode(), e.getKey(), true);
		synchronized(_keyQueue) {
			_keyQueue.add(m);
		}
	}
	...
	public void keyReleased(KeyEvent e) {
		KeyMessage m = new KeyMessage(e.getKeyCode(), e.getKey(), false);
		synchronized(_keyQueue) {
			_keyQueue.add(m);
		}
	}
	...
	public void mousePressed(MouseEvent e) {
		MouseMessage m  = new MouseMessage(e.getButton(), MouseEvent.PRESS, e.getX(), e.getY());
		synchronized(_mouseQueue) {
			_mouseQueue.add(m);
		}
	}
	...
	public void mouseReleased(MouseEvent e) {
		MouseMessage m  = new MouseMessage(e.getButton(), PMouseEvent.RELEASE, e.getX(), e.getY());
		synchronized(_mouseQueue) {
			_mouseQueue.add(m);
		}
	}
	...
	public void mouseDragged(MouseEvent e) {
		MouseMessage m  = new MouseMessage(e.getButton(), MouseEvent.DRAG, e.getX(), e.getY());
		synchronized(_mouseQueue) {
			_mouseQueue.add(m);
		}
	}
	...
	public void mouseMoved(MouseEvent e) {
		MouseMessage m  = new MouseMessage(e.getButton(), MouseEvent.MOVE, e.getX(), e.getY());
		synchronized(_mouseQueue) {
			_mouseQueue.add(m);
		}
	...
	public void mouseWheelMoved(MouseEvent e) {
		MouseWheelMessage m = new MouseWheelMessage(e.getCount());
		synchronized(_mouseWheelQueue) {
...
// 	 */
// 	public static POCodes.Button getButton(MouseEvent e) {
